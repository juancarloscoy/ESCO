        ...
        <div class="col-lg-6 mx-auto">
            ...
            <form method="POST" action="{{ route('orden.store') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="ID_OPERADOR" name="ID_OPERADOR" class="form-control">
                            @foreach ($operators as $operator)
                                <option value="{{$operator->ID_OPERADOR}}">{{$operator->NOMBRE}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-group">
                    ...
                    <textarea name="RESULTADO" class="form-control" id="RESULTADO" rows="2"></textarea>
                </div>
                <div class="form-group">
                    <label>Valor</label>
                    <input class="col-12" type="number" id="VALOR" name="VALOR">
                </div>
